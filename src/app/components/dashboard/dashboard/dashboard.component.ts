...
const DashboardTable_Data: DashboardTableDataType[] = [
  {
    id: 1,
    AssignTo: 'Skyler Hilda',
    img: './assets//images/users/11.jpg',
    mail: 'member@spruko.com',
    task: 'Sit sed takimata sanctus invidunt',
    project: 'Noa Dashboard UI',
    dueDate: '31 Oct 21',
  ...
  {
    id: 2,
    AssignTo: 'Daniel Obrien',
    img: './assets//images/users/12.jpg',
    mail: 'member@spruko.com',
    task: 'Diam lorem dolor no lorem.',
    project: 'Noa Dashboard UI',
    dueDate: '01 Nov 21',
    dueDateStatus: 'danger',
    status: '',
  ...
  {
    id: 3,
    AssignTo: 'William Turner',
    img: './assets//images/users/13.jpg',
    mail: 'member@spruko.com',
    task: 'Amet clita sea ut dolor consetetur, elitr.',
    project: 'Noa Dashboard UI',
    dueDate: '08 Nov 21',
    dueDateStatus: 'danger',
    status: '',
  ...
  {
    id: 4,
    AssignTo: 'Olena Tyrell',
    img: './assets//images/users/14.jpg',
    mail: 'member@spruko.com',
    task: 'Est sea erat at kasd.',
    project: 'Noa Dashboard UI',
    dueDate: '04 Nov 21',
    dueDateStatus: 'danger',
    status: '',
  ...
  {
    id: 5,
    AssignTo: 'Emilie Benett',
    img: './assets//images/users/5.jpg',
    mail: 'member@spruko.com',
    task: 'Rebum gubergren at kasd takimata clita.',
    project: 'Noa Dashboard UI',
    dueDate: '29 Oct 21',
    dueDateStatus: 'danger',
    status: '',
